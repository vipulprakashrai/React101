    ...
    <div>
      <div className="res-card">
        <img className="img1"
          ...
          alt=""
        />
        <h3 className="res-card-item">{resData.data.name}</h3>
        <p className="res-card-item">{resData.data.avgRating} star</p>
        <p className="res-card-item">{resData.data.cuisines.toString()} </p>
        <p className="res-card-item">{resData.data.deliveryTime} min</p>
